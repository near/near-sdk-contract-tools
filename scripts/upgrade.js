...
const configTestnet = {
    ...
    keyPath: require('os').homedir() + '/.near-credentials/testnet/ACCT.testnet.json',
    contractPath: './target/wasm32-unknown-unknown/testnet/contract.wasm',
    accountId: 'ACCT.testnet',
